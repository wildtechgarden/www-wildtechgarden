...
title: "Serve captures from Pi backyard camera"
...
aliases:
    ...
    - /docs/deploy-admin/pi-backyard-camera/backyard-pi-upload-serve/
    - /backyard-pi-sub-pages/backyard-pi-upload-serve/
    - /deploy-admin/pi-backyard-camera/pi-motion-upload/
tags:
    - linux
    - raspberry-pi
    - self-host
...
# It depends on the driver, some drivers doesn't detect a lost camera at all
